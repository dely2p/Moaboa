...
function movepage(dubbingpath, imgurl, webtoonwha){
	
	//movepage(${i.getdPath},${i.getwUrl},${i.getHit} });
	var webtoonno = imgurl.split('/');
	var wno; //webtton num
	for(var i=0;i<webtoonno.length();i++){		
		if(webtoonno[i]=='webtoon'){
			wno = webttoonno[i+1];
			break;
		}
	}
	setCookie('webtoonurl', dubbing, 1); //dubbing name 
	
	window.open("http://comic.naver.com/webtoon/detail.nhn?titleId="+ wno +"&no="+ webtoonwha,"_blank");
	window.open("view/dubbingplayer.do", "moaboa_player", 'scrollbars=no,toolbar=no,location=no,resizable=no,status=no,menubar=no,resizable=no,width=200,height=100,left=1300,top=100');
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="product-description product-description-brd margin-bottom-30">
                                <div class="overflow-h margin-bottom-5">
                                    <div class="pull-left">
                                        <h4 class="title-price"><a href="#" onclick="movepage(${i.getdPath},${i.getwUrl},${i.getHit});">${i.getdPath()}</a></h4>
