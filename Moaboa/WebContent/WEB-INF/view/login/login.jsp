        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5 reg">
                    <form id="sky-form1" class="log-reg-block sky-form" action="loginOk.do">
                        ...
                        <button id="loginOk" class="btn-u btn-u-sea-shop btn-block margin-bottom-20" type="submit">Log in</button>
