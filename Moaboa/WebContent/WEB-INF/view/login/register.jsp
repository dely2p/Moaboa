...
<!-- stts///////////////////////////////////////////////////////////////  -->
                ...
                <div class="col-md-5 reg">
                    <form id="sky-form4" class="log-reg-block sky-form" action="registerOk.do">
                        ...
                        <div class="login-input reg-input">
                            ...
                            <section>
                                <label class="input">
                                    <input type="text" id="id" name="userId" placeholder="userId" class="form-control">
                                </label>
                            </section>                        
